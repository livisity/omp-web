...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.annotationBadge": "标注 {n}",
    "chat.annotationSelected": "选中文本",
    "chat.annotationComment": "用户评论",
    "chat.commentAdd": "评论",
    "chat.commentPlaceholder": "对这段内容写下你的评论…（Enter 发送，Shift+Enter 换行）",
    "chat.commentLabel": "评论：",
    "chat.quoteConfirm": "确定",
    "chat.quoteCancel": "取消",
    "chat.toolCall": "次工具调用",
