...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.annotationBadge": "Annotation {n}",
    "chat.annotationSelected": "Selected text",
    "chat.annotationComment": "User comment",
    "chat.commentAdd": "Comment",
    "chat.commentPlaceholder": "Write a comment about this excerpt… (Enter to attach, Shift+Enter for newline)",
    "chat.commentLabel": "Comment: ",
    "chat.quoteConfirm": "Confirm",
    "chat.quoteCancel": "Cancel",
